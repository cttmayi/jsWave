...
public class Nodes extends Wave{
    ...
    public static int add(String name, int height, ArrayList<Integer> startTimes, 
            ArrayList<Integer> endTimes, ArrayList<Integer> nodeIndexs, 
    ...
    public void draw(Graphics g, int y, double wdt) {
        ...
        for (int id=0; id<x.size(); id++) {
            ...
            //System.out.println("C:" + lastX + ":" + xx + ":" + lastH + ":" + node.getHeight());
            ...
            if (w != 0) {
                //System.out.println("Draw:" + id + ":" + xx + ":" + (xx+w-1) + " w:" + w + " ww:" + ww);
                String name = null;
                if (id < listName.size()) {
